...
namespace SHSchool.Retake
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            RibbonBarItem item01 = RetakeAdmin.Instance.RibbonBarItems["前置作業"];
            ...
            item01["建議重補修名單"].Enable = UserAcl.Current["SHSchool.Retake.SuggestListForm"].Executable;
            ...
            RibbonBarItem item02 = RetakeAdmin.Instance.RibbonBarItems["前置作業"];
            item02["科目管理"].Image = Properties.Resources.重補修科目管理_project_64;
            item02["科目管理"].Size = RibbonBarButton.MenuButtonSize.Large;
            item02["科目管理"].Enable = UserAcl.Current["SHSchool.Retake.SubjectListForm"].Executable;
            ...
            RibbonBarItem item03 = RetakeAdmin.Instance.RibbonBarItems["前置作業"];
            item03["課表管理"].Image = Properties.Resources.重補修課表管理_schedule_write_64;
            item03["課表管理"].Size = RibbonBarButton.MenuButtonSize.Large;
            item03["課表管理"].Enable = UserAcl.Current["SHSchool.Retake.CourseTimetableForm"].Executable;
            ...
            RibbonBarItem item05 = RetakeAdmin.Instance.RibbonBarItems["前置作業"];
            ...
            RibbonBarItem item04 = RetakeAdmin.Instance.RibbonBarItems["前置作業"];
            item04["開課"].Image = Properties.Resources.開課;
            item04["開課"].Size = RibbonBarButton.MenuButtonSize.Large;
            item04["開課"].Enable = UserAcl.Current["SHSchool.Retake.CourseTimetableForm"].Executable;
            ...
            RibbonBarItem item11 = RetakeAdmin.Instance.RibbonBarItems["前置作業"];
            ...
            catalog01.Add(new RibbonFeature("SHSchool.Retake.SuggestListForm", "建議重補修名單"));

            // 重補修科目管理
            Catalog catalog02 = RoleAclSource.Instance["重補修"]["功能按鈕"];
            catalog02.Add(new RibbonFeature("SHSchool.Retake.SubjectListForm", "科目管理"));
            ...
            catalog09.Add(new RibbonFeature("SHSchool.Retake.ImportCourse", "匯入課程"));
            ...
            catalogSc03.Add(new RibbonFeature("SHSchool.Retake.ExportCourseInfo", "匯出課程"));
            ...
            catalog27.Add(new RibbonFeature("SHSchool.Retake.ClearingForm", "學期結算"));
